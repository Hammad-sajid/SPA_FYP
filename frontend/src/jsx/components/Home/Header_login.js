      ...
      <div className="container-fluid px-4">
        ...
        <div className="collapse navbar-collapse" id="mainNavbar">
          ...
          <div className="d-flex flex-column flex-lg-row gap-2 gap-lg-3">
            <Link to="/dashboard" className="btn cus-eff btn-outline-light text-nowrap px-4 py-2 fw-semibold">
              <span>Dashboard</span>
            </Link>
            {/* <button onClick={handleLogout} className="btn cus-eff btn-outline-light text-nowrap px-4 py-2 fw-semibold">
              <span>Logout</span>
            </button> */}
